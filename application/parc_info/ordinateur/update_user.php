...
if(!$db){
   ...
   $sql = "update materiel set code_mat='$code_mat',code_bp= '$code_bp',designation='$designation',marque='$marque',numero_serie='$numero_serie',
taille_ecran='$taille_ecran',type_clavier='$type_clavier',type_souris='$type_souris',taille_disk='$taille_disk',taille_ram='$taille_ram',type_cable='$type_cable' where code_mat='$code_mat'";
